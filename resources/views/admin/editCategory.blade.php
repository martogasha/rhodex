...
<head>
    ...
    <!-- Title -->
    <title>Mylonix - Edit {{$category->category_name}}</title>
...
<div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="{{url('stock')}}" role="button" aria-haspopup="true" aria-expanded="false">
                       ...
                       <li class="nav-item dropdown">
                    <a class="nav-link active-page" href="{{url('category')}}" role="button" aria-haspopup="true" aria-expanded="false">
                        <i class="icon-book-open nav-icon"></i>
                        Category
                    </a>
                </li>
            ...
            <div class="baguetteBoxThree gallery">
                ...
                <div class="row gutters">
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                            <form action="{{url('eCategory')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" value="{{$category->id}}" name="category_name">
                          
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Category Name:</label>
                                <input type="text" class="form-control" value="{{$category->category_name}}" name="categoryName" id="recipient-name">
                            </div>
                            <div class="form-group">
    ...
    ************* -->
    ...
    <!-- Footer start -->
    <footer class="main-footer">© Mylonix 2020</footer>
    <!-- Footer end -->
