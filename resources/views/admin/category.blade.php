            ...
            <div class="baguetteBoxThree gallery">
                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
                        <a href="{{asset('uploads/product/'.$category->category_photo)}}" class="effects">
                            <img src="{{asset('uploads/product/'.$category->category_photo)}}" class="img-fluid" alt="Wafi Admin">
                            <div class="overlay">
                        ...
                        <div class="row">
                        <a href="{{url('editCategory',$category->id)}}"><button class="btn btn-info">
                            Edit
                            </button></a>
                        <a href="{{url('deleteCategory',$category->id)}}"><button class="btn btn-danger">
                                Delete
                            </button></a>
                        </div>
