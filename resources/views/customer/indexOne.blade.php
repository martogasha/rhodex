                  ...
                  <div class="advance-wrap tw_fade_anim">
                     ...
                     <div class="advance-item">
                        ...
                        <div class="advance-content d-flex align-items-center justify-content-between flex-wrap tw-px-4 tw-py-4">
                           <h6 class="tw-text-2xl fw-normal mb-0"><a href="{{url('contact')}}">Maasai Mara</a></h6>
                           <a class="advance-btn tw-w-10 tw-h-10 lh-1 d-inline-flex align-items-center justify-content-center rounded-circle text-heading hover-bg-main-600 hover-border-main-600 hover-text-heading" href="{{url('contact')}}"><span><i class="ph ph-arrow-right"></i></span></a>
                        </div>
                     </div>
                     ...
                     <div class="advance-item">
                        ...
                        <div class="advance-content d-flex align-items-center justify-content-between flex-wrap tw-px-4 tw-py-4">
                           <h6 class="tw-text-2xl fw-normal mb-0"><a href="{{url('contact')}}">Amboseli</a></h6>
                           <a class="advance-btn tw-w-10 tw-h-10 lh-1 d-inline-flex align-items-center justify-content-center rounded-circle text-heading hover-bg-main-600 hover-border-main-600 hover-text-heading" href="{{url('contact')}}"><span><i class="ph ph-arrow-right"></i></span></a>
                        </div>
                     </div>
                     ...
                     <div class="advance-item">
                        ...
                        <div class="advance-content d-flex align-items-center justify-content-between flex-wrap tw-px-4 tw-py-4">
                           <h6 class="tw-text-2xl fw-normal mb-0"><a href="{{url('contact')}}">Hell's Gate</a></h6>
                           <a class="advance-btn tw-w-10 tw-h-10 lh-1 d-inline-flex align-items-center justify-content-center rounded-circle text-heading hover-bg-main-600 hover-border-main-600 hover-text-heading" href="{{url('contact')}}"><span><i class="ph ph-arrow-right"></i></span></a>
                        </div>
                     </div>
                     ...
                     <div class="advance-item">
                        ...
                        <div class="advance-content d-flex align-items-center justify-content-between flex-wrap tw-px-4 tw-py-4">
                           <h6 class="tw-text-2xl fw-normal mb-0"><a href="{{url('contact')}}">Diani</a></h6>
                           <a class="advance-btn tw-w-10 tw-h-10 lh-1 d-inline-flex align-items-center justify-content-center rounded-circle text-heading hover-bg-main-600 hover-border-main-600 hover-text-heading" href="{{url('contact')}}"><span><i class="ph ph-arrow-right"></i></span></a>
                        </div>
                     </div>
                     ...
                     <div class="advance-item">
                        ...
                        <div class="advance-content d-flex align-items-center justify-content-between flex-wrap tw-px-4 tw-py-4">
                           <h6 class="tw-text-2xl fw-normal mb-0"><a href="{{url('contact')}}">Mount Kenya</a></h6>
                           <a class="advance-btn tw-w-10 tw-h-10 lh-1 d-inline-flex align-items-center justify-content-center rounded-circle text-heading hover-bg-main-600 hover-border-main-600 hover-text-heading" href="{{url('contact')}}"><span><i class="ph ph-arrow-right"></i></span></a>
                        </div>
                     </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="offer-wrapper overflow-hidden tw-mb-7 tw_fade_anim" data-delay=".3">
                    <div class="position-relative z-1">
                        <a href="{{url('contact')}}"><img src="assets/images/thumbs/offer-thumb1.jpg" alt="thumb"></a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="offer-wrapper active overflow-hidden tw-mb-7 tw_fade_anim" data-delay=".5">
                    <div class="position-relative z-1">
                        <a href="{{url('contact')}}"><img src="assets/images/thumbs/offer-thumb2.jpg" alt="thumb"></a>
                        <div class="offer-title">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="offer-wrapper overflow-hidden tw-mb-7 tw_fade_anim" data-delay=".7">
                    <div class="position-relative z-1">
                        <a href="{{url('contact')}}"><img src="assets/images/thumbs/offer-thumb3.jpg" alt="thumb"></a>
                        <div class="offer-title">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="text-center">
                    <a class="tw-btn-hover-black bg-main-600 tw-py-5 tw-px-12 text-uppercase text-heading font-heading d-inline-flex align-items-center tw-gap-2 tw-rounded-lg" href="{{url('contact')}}">EXPLORE MORE <span class="d-inline-block lh-1 tw-text-lg"><i class="ph ph-arrow-up-right"></i></span></a>
                </div>
            </div>
        </div>
    </div>
