...
<head>
    ...
    <!-- Title -->
    <title>Rhodex Recruiters Limited - contact</title>
    <!-- Favicon -->
...
<!-- Nav menu End  -->
            ...
            <div class="header-right d-flex tw-gap-28">
                ...
                <div class="header-button header-two-button">
                    <a class="tw-btn-hover-white bg-main-600 tw-py-5 tw-px-14 text-capitalize text-heading font-heading d-inline-flex align-items-center tw-gap-2 tw-rounded-lg" href="contact.html">Booking today <span class="d-inline-block lh-1 tw-text-lg"><i class="ph ph-arrow-up-right"></i></span></a>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="text-center">
                    ...
                    <h2 class="breadcrumb-title tw-text-25 fw-normal text-white tw-char-animation"> Contact us</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-11">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="tw_fade_anim" data-delay=".3">
                                <div class="section-two-wrapper tw-mb-14">
                                    <h6 class="section-two-subtitle tw-text-xl text-uppercase text-main-three-800 tw-mb-4">Get In Touch</h6>
                                    <h2 class="section-two-title tw-text-16 fw-normal tw-mb-6 tw-char-animation">Contact Us</h2>
                                    <p class="fw-medium tw-text-lg">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque inventore</p>
                                </div>
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-flex tw-gap-4 tw-mb-13">
                                            <div>
                                                <span class="d-inline-block lh-1 text-heading tw-text-3xl"><i class="ph-bold ph-map-pin"></i></span>
                                            </div>
                                            <div>
                                                <h4 class="tw-text-2xl fw-normal tw-mb-3">Location</h4>
                                                <p>55 Main street, 2nd block, <br> Nairobi</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-flex tw-gap-4 tw-mb-13">
                                            <div>
                                                <span class="d-inline-block lh-1 text-heading tw-text-3xl"><i class="ph ph-phone"></i></span>
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-flex tw-gap-4 tw-mb-13">
                                            <div>
                                                <span class="d-inline-block lh-1 text-heading tw-text-3xl"><i class="ph ph-envelope"></i></span>
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <div class="d-flex tw-gap-4 tw-mb-13">
                                            <div>
                                                <span class="d-inline-block lh-1 text-heading tw-text-3xl"><i class="ph ph-share-network"></i></span>
                                            </div>
                                            <div>
                                                ...
                                                <ul class="d-flex align-items-center tw-gap-2">
                                                    ...
                                                    <li>
                                                        <a class="tw-w-9 tw-h-9 lh-1 d-inline-flex align-items-center justify-content-center border border-neutral rounded-circle text-heading hover-bg-main-600 hover-text-heading hover-border-main-600" href="https://www.linkedin.com/"><i class="ph-bold ph-instagram-logo"></i></a>
                                                    </li>
                                                    <li>
                                                        <a class="tw-w-9 tw-h-9 lh-1 d-inline-flex align-items-center justify-content-center border border-neutral rounded-circle text-heading hover-bg-main-600 hover-text-heading hover-border-main-600" href="https://www.pinterest.com/"><i class="ph-bold ph-dribbble-logo"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="tw-mb-8">
                                    <img src="assets/images/thumbs/contact-ip-bg.jpg" alt="thumbs">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                            <div class="contact-two-form bg-white tw-py-20 tw-ps-10 tw-pe-20 tw-mb-7 tw_fade_anim" data-delay=".5">
                                <div class="tw-mb-10">
                                    <h2 class="tw-text-12 fw-normal tw-mb-4 tw-char-animation">Fill Up The Form</h2>
                                    <p class="tw-text-lg fw-medium">Your email address will not be published. Required fields are marked *</p>
                                </div>
                                <form action="#">
                                    <div class="row">
                                            <div class="col-xl-12">
                                                <div class="position-relative tw-mb-11">
                                                        <span class="position-absolute top-50 start-0 translate-middle-y text-heading tw-text-xl"><i class="ph-bold ph-user"></i></span>
                                                        <input type="text" class="form-control rounded-0 bg-white shadow-none border-none border-bottom border-bottom-neutral text-heading tw-ps-8 tw-pe-13 focus-border-main-600 tw-h-14 tw-placeholder-text-neutral-700 focus-tw-placeholder-text-hidden tw-placeholder-transition-2" placeholder="Your Name*">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="position-relative tw-mb-11">
                                                        <span class="position-absolute top-50 start-0 translate-middle-y text-heading tw-text-xl"><i class="ph ph-envelope"></i></span>
                                                        <input type="email" class="form-control rounded-0 bg-white shadow-none border-none border-bottom border-bottom-neutral text-heading tw-ps-8 tw-pe-13 focus-border-main-600 tw-h-14 tw-placeholder-text-neutral-700 focus-tw-placeholder-text-hidden tw-placeholder-transition-2" placeholder="Email Address**">
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="position-relative tw-mb-11">
                                                        <span class="position-absolute top-0 start-0 tw-mt-1 text-heading tw-text-xl"><i class="ph-bold ph-note-pencil"></i></span>
                                                        <textarea class="form-control rounded-0 tw-h-135-px bg-white shadow-none border-none border-bottom border-bottom-neutral text-heading tw-ps-8 tw-pe-13 focus-border-main-600 tw-placeholder-text-neutral-700 focus-tw-placeholder-text-hidden tw-placeholder-transition-2" placeholder="Enter Your Message here"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div>
                                                    <button class="tw-btn-hover-black bg-main-600 tw-py-5 tw-px-14 text-capitalize text-heading font-heading d-inline-flex align-items-center tw-gap-2 tw-rounded-lg">Send us Mesaage <span class="d-inline-block lh-1 tw-text-lg"><i class="ph ph-arrow-up-right"></i></span></button>
                                                </div>
                                            </div>
                                    </div>
                                </form>
...
<!-- Mirrored from wowtheme7.com/tf/elitestay/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Dec 2025 10:15:16 GMT -->
</html>