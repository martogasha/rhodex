...
<title>Data Recovery and Backup</title>
...
<div class="col-sm-8 col-md-8 col-lg-9 mtb_30">
    ...
    <div class="breadcrumb ptb_20">
        <h1>Data Recovery and Backup</h1>
        <ul >
            <li><a href="index-2.html">Home</a></li>
            <li class="active">Data Recovery and Backup</li>
        </ul>
    </div>
    <!-- =====  BREADCRUMB END===== -->
    <div class="row">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-md-10 col-lg-8">
                        <div class="header-section">
                            <h2 class="title">Data Recovery and <span>Backup</span></h2>
                            <p>Worry No more. We have partnered with data Experts to help you Get the most Corrupted/Lost data. Your Data is Crucial, that’s why we have Backup procedures for what matters to You.</p>
                            <br>
