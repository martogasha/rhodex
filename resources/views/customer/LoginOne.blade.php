...
<!-- Mirrored from themezhub.net/kumo-new-update/kumo/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jun 2025 09:25:08 GMT -->
<head>
		<meta charset="utf-8" />
				...
				<div class="container">
					<div class="row align-items-start justify-content-between">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<form class="border p-3 rounded" id="login-form" action="{{route('loginCustomOne')}}" method="post">
								@csrf				
