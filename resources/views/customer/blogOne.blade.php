...
<!-- Mirrored from themezhub.net/kumo-new-update/kumo/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jun 2025 09:24:08 GMT -->
<head>
		<meta charset="utf-8" />
		<meta name="author" content="Themezhub" />
		<meta name="viewport" content="width=device-width, initial-scale=1">
		
        <title>Vivi- Blog Page</title>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
							<div class="_blog_wrap">
								<div class="_blog_thumb mb-2">
									<a href="blog-detail.html" class="d-block"><img src="asse/img/bl-1.png" class="img-fluid rounded" alt="" /></a>
								</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
							<div class="_blog_wrap">
								<div class="_blog_thumb mb-2">
									<a href="blog-detail.html" class="d-block"><img src="asse/img/bl-2.png" class="img-fluid rounded" alt="" /></a>
								</div>
								<div class="_blog_caption">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
							<div class="_blog_wrap">
								<div class="_blog_thumb mb-2">
									<a href="blog-detail.html" class="d-block"><img src="asse/img/bl-3.png" class="img-fluid rounded" alt="" /></a>
								</div>
								<div class="_blog_caption">
						...
						<div class="modal-body p-5">
							...
							<form id="login-form" action="{{route('loginCustomOne')}}" method="post">
								...
								<div class="form-group text-center mb-0">
									<p class="extra">Not a member?<a href="{{url('Login')}}" class="text-dark"> Register</a></p>
								</div>
							</form>
						</div>
					</div>
